...
from uniref_vae.gvp.data_gvp import DatasetKmers
...
class InfoTransformerVAE(pl.LightningModule):
    def __init__(
        ...
        # add a double linear layer with gelu activation with 512 -> 2048 -> 512 dims, put in a module
